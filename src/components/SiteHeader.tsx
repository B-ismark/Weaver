...
/**
 * Shared editorial header shell. Deliberately un-Pinterest: a serif wordmark with
 * a small gold "hub" glyph (the orb-weaver motif) instead of a logo + fat centered
 * search bar. Page-specific controls (nav, back link, search) are passed as
 * `children` and sit on the right; the wordmark always routes home.
 *
